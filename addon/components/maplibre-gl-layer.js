...
import layout from '../templates/components/maplibre-gl-layer';

/**
  Adds a data source to the map.
  The API matches the maplibre [source docs](https://www.maplibre.com/maplibre-gl-js/api/#sources).
...
export default Component.extend({
  ...
  */
  ...
  /**
   * @property _sourceId
   * @private for use by maplibre-gl-source to pass in its sourceId
   */
  ...
  _envConfig: computed('_layerType', function () {
    ...
    return (config['maplibre-gl'] ?? {})[this._layerType];
  }).readOnly(),
